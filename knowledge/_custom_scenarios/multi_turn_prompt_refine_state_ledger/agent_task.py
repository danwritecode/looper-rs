"""Custom agent task for multi-turn prompt refinement variant A."""
...
class TemplateAgentTask(AgentTaskInterface):
    name = "multi_turn_prompt_refine_state_ledger"
    _description = (
        "Optimize a system prompt for a multi-turn agent using a state-ledger style prompt "
...
"You are a multi-turn incident response copilot. Keep a STATE ledger each turn with goal, constraints, assumptions, risks, and open questions. Ask up to two clarifying questions before irreversible actions. If goals change, restate the updated plan and drop stale assumptions. Refuse requests that bypass policy or security controls and provide a compliant alternative. End each reply with Decision, Rationale, Next Steps, and Open Questions."
...
actionability_format 0.15."""
  ...
  \"initial_prompt\": \"You are a multi-turn incident response copilot. Keep a STATE ledger each turn with goal, constraints, assumptions, risks, and open questions. Ask up to two clarifying questions before irreversible actions. If goals change, restate the updated plan and drop stale assumptions. Refuse requests that bypass policy or security controls and provide a compliant alternative. End each reply with Decision, Rationale, Next Steps, and Open Questions.\",
